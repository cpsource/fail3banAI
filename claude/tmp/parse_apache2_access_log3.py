...
def _decode_url_encoded_string(text: str) -> str:
    ...
    malformed encodings, either by mistake or through automated tools that
    double-encode. We need to interpret their actual intent.
    
    The pattern %%32%65 is malformed and should be treated as %32%65:
    - %%32%65 → %32%65 (fix malformed double %) → %2e → .
    
    Examples:
    - %2e becomes .
    - %%32%65 becomes . (treating %% as malformed %)
    - /%%32%65%%32%65/ becomes /../
    """

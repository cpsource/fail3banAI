...
class Parselet_POST:
    ...
    def compress_line(self, log_line):
        ...
        pattern = r'(\d{1,3}(?:\.\d{1,3}){3}) - - \[(.*?)\] "(POST) (/.*?) HTTP/\d\.\d" (\d{3}) (\d+) ".*?" "(.*?)"'
...
if __name__ == "__main__":
    ...
    log_line = '135.125.244.48 - - [24/Sep/2024:21:57:49 +0000] "POST / HTTP/1.1" 204 152 "-" "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Safari/537.36"'
